...
<body>
    ...
    <div class="content">
        ...
        <div class="innerOuter">
            ...
            <form id="enrollForm" method="post" action="boards" enctype="multipart/form-data"> <!-- enctype 무조건 이렇게 적기  --> 
                <table align="center">
                    <tr>
					...
					function changeImage(file){
						...
						if(file.files.length){ // 파일이 첨부됨 
							...
							reader.onload = function(e){
								...
								const img = "https://w7.pngwing.com/pngs/737/121/png-transparent-computer-icons-cancellation-cancel-s-angle-text-logo-thumbnail.png";
								imgEl.src = img;
						}
					}
